    ...
    >
      <div style={bodyStyle}>
        ...
        <div style={{ position: 'absolute', top: -76, left: 0, right: 0, overflow: 'hidden', pointerEvents: 'none' }}>
          ...
          <div className="flood-wave-anim" style={{ animationDuration: '4.8s', width: '300%', display: 'flex' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', top: -68, left: 0, right: 0, overflow: 'hidden' }}>
            <div className="flood-wave-anim" style={{ animationDuration: '6.5s', animationDirection: 'reverse', width: '300%', display: 'flex' }}>
              <svg viewBox="0 0 1440 80" style={{ width: '33.3333%', display: 'block', flexShrink: 0, height: 80 }} preserveAspectRatio="none">
          ...
          <div style={{ position: 'absolute', top: -55, left: 0, right: 0, overflow: 'hidden' }}>
            <div className="flood-wave-anim" style={{ animationDuration: '9s', width: '300%', display: 'flex' }}>
              <svg viewBox="0 0 1440 80" style={{ width: '33.3333%', display: 'block', flexShrink: 0, height: 80 }} preserveAspectRatio="none">
